      ...
      <div className="flex">
        ...
        <aside className="w-64 p-8 border-r border-gray-200 min-h-screen">
          <div className="mb-8">
            ...
            <p className="text-gray-500 text-lg">{filteredProjects.length}/90</p>
          </div>
              ...
              >
                ...
                <span
                  className={`block font-medium text-xl leading-[30px] transition-all duration-300
                    ${selectedCategory === category ? 'translate-x-6 text-black' : 'translate-x-0 text-gray-400 hover:text-gray-600'}`}
                >
                  {category}
                </span>
              </button>
