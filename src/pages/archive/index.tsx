...
const HEADER_OFFSET_DESKTOP = 'lg:pt-24';
const HEADER_OFFSET_MOBILE = 'pt-16';
...
export default function Archive() {
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex lg:hidden fixed top-0 left-0 right-0 z-50 items-center justify-between p-4 bg-white">
        <h1 className={`${avantGarde.className} font-[400] text-[40px] text-[#1C1C1C]`}>Archive</h1>
        <Mobile_HeaderBtn />
      </div>

      {/* 메인 콘텐츠 영역: 헤더의 높이만큼 상단 패딩/마진 추가 */}
      <main className={`flex-grow ${HEADER_OFFSET_DESKTOP} ${HEADER_OFFSET_MOBILE}`}>
        
        {/* 데스크톱 뷰 */}
        <div className="hidden lg:block p-8 flex flex-col">
      ...
      <div className="hidden lg:block lg:z-40 flex-shrink-0">
        <Footer />
      </div>
