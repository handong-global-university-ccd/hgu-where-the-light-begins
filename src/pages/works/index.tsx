      ...
      {isSearchOpen && (
        <div className="lg:hidden px-5 py-4 relative">
          ...
          <button
              ...
              className="absolute right-0 top-1/2 px-4 pb-3 transform -translate-y-1/2 text-[#7C7C7C] hover:text-[#1C1C1C]"
            >
      ...
      <div className="flex flex-col lg:flex-row">
        ...
        <main className="flex-1 p-4 lg:p-8">
          {filteredProjects.length === 0 ? (
            ...
            <div className="grid grid-cols-2 gap-x-3.5 lg:grid-cols-3 lg:gap-y-8 lg:gap-x-0">
